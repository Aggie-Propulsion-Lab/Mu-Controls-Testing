...
// Configure Manual IPv4
const IPAddress address = {192,0,0,10};
const IPAddress subnetmask = {255,255,255,240};
const IPAddress gw = {192,0,0,254};
...
void setup() {
  ...
  if (!Ethernet.begin(address, subnetmask, gw)) {
